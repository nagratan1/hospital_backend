 ...
 *    * `--sentinel-fuse NODE_SEA_FUSE_REMOVED` \- The [fuse](https://www.electronjs.org/docs/latest/tutorial/fuses) used by the Node.js project to detect if a file has been
 * injected.
 ...
 *        --sentinel-fuse NODE_SEA_FUSE_REMOVED
 *    ```
