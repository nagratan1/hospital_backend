...
* [`punycode.js` by _Ben Noordhuis_](https://github.com/joyent/node/blob/REMOVEDa3fe9377/lib/punycode.js) (note: [not fully compliant](https://github.com/joyent/node/issues/2072))
...
| [![twitter/mathias](https://gravatar.com/avatar/REMOVED?s=70)](https://twitter.com/mathias "Follow @mathias on Twitter") |
|---|
