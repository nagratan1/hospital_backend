...
test('openbsd', () => {
    expect(bcrypt.hashSync("REMOVEDREMOVED00000000", "$2a$05$CCCCCCCCCCCCCCCCCCCCC.")).toStrictEqual("$2a$05$CCCCCCCCCCCCCCCCCCCCC.6.O1dLNbjod2uo0DVcW.jHucKbPDdHS")
    expect(bcrypt.hashSync("REMOVEDREMOVED00000000", "$2b$05$CCCCCCCCCCCCCCCCCCCCC.")).toStrictEqual("$2b$05$CCCCCCCCCCCCCCCCCCCCC.6.O1dLNbjod2uo0DVcW.jHucKbPDdHS")
})

test('long_passwords', () => {
    // bcrypt wrap-around bug in $2a$
    expect(bcrypt.hashSync("REMOVEDREMOVEDREMOVEDREMOVEDREMOVEDREMOVEDREMOVED4567890123456789012345678901234", "$2a$05$CCCCCCCCCCCCCCCCCCCCC.")).toStrictEqual("$2a$05$CCCCCCCCCCCCCCCCCCCCC.6.O1dLNbjod2uo0DVcW.jHucKbPDdHS")
    ...
    expect(bcrypt.hashSync("REMOVEDREMOVEDREMOVEDREMOVEDREMOVEDREMOVEDREMOVED4567890123456789012345678901234", "$2b$05$CCCCCCCCCCCCCCCCCCCCC.")).toStrictEqual("$2b$05$CCCCCCCCCCCCCCCCCCCCC.XxrQqgBi/5Sxuq9soXzDtjIZ7w5pMfK")
    expect(bcrypt.hashSync("REMOVEDREMOVEDREMOVEDREMOVEDREMOVEDREMOVEDREMOVEDREMOVED", "$2b$05$CCCCCCCCCCCCCCCCCCCCC.")).toStrictEqual("$2b$05$CCCCCCCCCCCCCCCCCCCCC.XxrQqgBi/5Sxuq9soXzDtjIZ7w5pMfK")
})
