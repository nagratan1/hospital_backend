...
class uServer extends server_1.BaseServer {
    ...
    _applyMiddlewares(req, res, callback) {
        ...
        super._applyMiddlewares(req, req.res, (err) => {
            ...
            // see https://github.com/expressjs/session/blob/REMOVEDf65159c6/index.js#L220-L244
            req.res.writeHead();
            callback(err);
        });
    }
...
class ResponseWrapper {
    ...
    // needed by vary: https://github.com/jshttp/vary/blob/REMOVEDd0bcfa8f/index.js#L134
    getHeader() { }
    writeStatus(status) {
        if (this.isAborted)
            return;
