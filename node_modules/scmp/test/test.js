...
describe('scmp', function () {
  it('should return true for identical strings', function () {
    ...
    assert(scmp(Buffer.from('REMOVEDd8381b26', 'hex'), Buffer.from('REMOVEDd8381b26', 'hex')))
  })
  ...
  it('should return false for non-identical strings', function () {
    ...
    assert(!scmp(Buffer.from('REMOVEDd8381b26', 'hex'), Buffer.from('REMOVED779a52db', 'hex')))
  })
