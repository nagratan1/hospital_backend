...
export declare class Decimal128 extends BSONValue {
     ...
     * ```ts
     * > let d = Decimal128.fromString('37.REMOVED5')
     * Uncaught:
     * BSONError: "37.REMOVED5" is not a valid Decimal128 string - inexact rounding
     ...
     *
     * > d = Decimal128.fromStringWithRounding('37.REMOVED5')
     * new Decimal128("37.REMOVED")
     * ```
     * @param representation - a numeric string representation.
     */
