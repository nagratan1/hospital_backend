...
- Readme link [fixed](https://github.com/micromatch/picomatch/pull/13/commits/REMOVED563b05df) by @danez.
- `options.capture` now works as expected when fastpaths are enabled. See https://github.com/micromatch/picomatch/pull/12/commits/REMOVED3b037304. Thanks to @DrPizza.
